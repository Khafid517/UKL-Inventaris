<!DOCTYPE html>
  ...
  <ul class="sidenav black-text" id="sidenav">
    ...
    <section class="">
        <div class="container">
            <h3 class="light center white-text text-darken-3 efek">Jenis</h3>
            <div class="row card-panel">
              <a href="<?= base_url('')?>/Admin_dashboard/add_jenis" class="waves-effect waves-light btn pink darken-3">Tambah Jenis </a>
              ...
              <table class="responsive-table highlight centered">
                ...
                foreach($pinjam as $pet):?>
                  <tr>
                    <td><?= $p++;?></td>
                    <td><?= $pet['nama_jenis'];?></td>
                    <td><?= $pet['keterangan'];?></td>
                    <td>
                      <a href="<?= base_url('')?>Admin_dashboard/edit_jenis/<?= $pet['id_jenis']?>" class="waves-effect waves-light btn btn purple darken-3">Ubah</a>
                      <a href="<?= base_url('')?>Admin_dashboard/hapus_jenis/<?= $pet['id_jenis']?>" class="waves-effect waves-light btn red darken-">HAPUS</a>
                    </td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
