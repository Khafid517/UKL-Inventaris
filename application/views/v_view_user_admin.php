    ...
    <div class="parallax"><img src="<?= base_url('')?>assets/img/u.jpg"></div>
      <div class="container efek">
        <div class="row">
          ...
          <h4 class="center light white-text">Pengguna</h4></div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="card-panel col m5 pull-m1 center pilih">
         <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="<?= base_url('')?>assets/img/1.jpg">
         </div>
         <div class="card-content">
            <p><a href="<?= base_url('')?>Admin_dashboard/petugas" class="waves-effect waves-light btn pink lighten-3">Tabel Petugas</a></p>
        </div>
        </div>
        <div class="card-panel col m5 push-m3 center pilih">
         <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="<?= base_url('')?>assets/img/2.jpg">
         </div>
         <div class="card-content">
            <p><a href="<?= base_url('')?>Admin_dashboard/pegawai" class="waves-effect waves-light btn pink lighten-3">Tabel Pegawai</a></p>
        </div>
        </div>
      </div>
    </div>
