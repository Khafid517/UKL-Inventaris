<!DOCTYPE html>
  ...
  <ul class="sidenav black-text" id="sidenav">
    ...
    <section class="formulir">
        <div class="container">
            <h3 class="light center white-text text-darken-3 efek">Tambah Jenis</h3>
            <div class="row">
            <form action="<?= base_url('')?>Admin_dashboard/proses_add_jenis" method="post">
              <div class=" card-panel center">
                <div class="input-field">
                  <i class="material-icons prefix">account_circle</i>
                  <input name="jenis" id="nama" type="text" required>
                  <label for="nama">Jenis</label>
                </div>
                <div class="input-field row">
                  <i class="material-icons prefix">phone_android</i>
                  <input name="deskripsi" id="hp" type="text" required>
                  <label for="hp">Deskripsi</label>
                </div>
                <button type="submit" class="waves-effect waves-light btn pink lighten-3">TAMBAH</button>
                </div>
              </div>
            </form>
            </div>
