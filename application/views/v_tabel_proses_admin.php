<!DOCTYPE html>
  <html>
    <head>
	    ...
	    <style type="text/css">
          ...
          body {
            background-image: url("<?= base_url('')?>assets/img/w.jpg");
  ...
  <ul class="sidenav black-text" id="sidenav">
    ...
    <section class="">
        <div class="container">
            <h3 class="light center white-text text-darken-3 efek">Dalam Proses</h3>
              ...
              <table class="responsive-table highlight centered">
                ...
                foreach($pinjam as $pet):?>
                  <tr>
                    ...
                    <td><a href="<?= base_url('')?>Admin_dashboard/edit_proses/<?= $pet['id_pinjam']?>/<?= $pet['id_inventaris']?>" class="waves-effect waves-light btn purple darken-3">Konfirmasi</a></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
