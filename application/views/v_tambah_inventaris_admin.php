<!DOCTYPE html>
  ...
  <ul class="sidenav black-text" id="sidenav">
    ...
    <section class="formulir">
        <div class="container">
            <h3 class="light center white-text text-darken-3 efek">Tambah Inventaris</h3>
            <div class="row">
            <form action="<?= base_url('')?>Admin_dashboard/proses_add_inventaris" method="post">
              <div class=" card-panel center">
                ...
                <div class="input-field row">
                  ...
                  <input name="telp" id="hp" type="text" required>
                ...
                <div class="input-field row">
                  ...
                  <label for="email">Id Jenis</label>
                </div>
                <div class="input-field row">
